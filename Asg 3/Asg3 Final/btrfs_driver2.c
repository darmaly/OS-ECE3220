...
int main(){
  ...
  fd[0] = btrfs_create( "file.txt" );
  if( fd[0] == 0 ) printf( "first create failed\n" );

  fd[1] = btrfs_create( "my_file" );
  if( fd[1] == 0 ) printf( "second create failed\n" );

  btrfs_list_directory();

  count1 = btrfs_write( fd[0], buffer1, length1 );
  printf( "%d bytes written to first file\n", count1 );

  count2 = btrfs_write( fd[1], buffer2, length2 );
  ...
  btrfs_seek( fd[0], 600 );
  count3 = btrfs_read( fd[0], buffer3, 640 );
  printf( "%d bytes read from first file\n", count3 );
  buffer3[count3] = '\0';
  printf( "[%s]\n", buffer3 );

  btrfs_seek( fd[0], 250 );
  count3 = btrfs_read( fd[0], buffer3, 20 );
  printf( "%d bytes read from first file\n", count3 );
  buffer3[count3] = '\0';
  printf( "[%s]\n", buffer3 );

  fd[2] = btrfs_create( "file.txt" );
  printf( "fd for creating a file with identical name" );
  printf( " as existing file - %d\n", fd[2] );
  fd[2] = btrfs_create( "file3" );
  fd[3] = btrfs_create( "file4" );
  fd[4] = btrfs_create( "file5" );
  fd[5] = btrfs_create( "file6" );
  fd[6] = btrfs_create( "file7" );
  fd[7] = btrfs_create( "file8" );
  fd[8] = btrfs_create( "file9" );
  fd[9] = btrfs_create( "file10" );
  fd[10] = btrfs_create( "file11" );
  fd[11] = btrfs_create( "file12" );
  fd[12] = btrfs_create( "file13" );
  fd[13] = btrfs_create( "file14" );
  fd[14] = btrfs_create( "file15" );
  fd[15] = btrfs_create( "file16" );
  ...
  fd[16] = btrfs_create( "added_1" );
  fd[17] = btrfs_create( "added_2" );
